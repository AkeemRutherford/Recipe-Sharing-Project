        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Use Pexels or Unsplash for free images</p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={8}
                className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent font-mono text-sm"
                placeholder="Format: amount | ingredient name (one per line)&#10;Example:&#10;2 cups | All-purpose flour&#10;1 tsp | Salt&#10;3 | Large eggs"
              />
              <p className="text-xs text-gray-500 mt-1">Use format: amount | ingredient name (one per line)</p>
            </div>
